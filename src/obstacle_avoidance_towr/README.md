...
* Install dependencies [CMake], [catkin], [Eigen], [Ipopt], [ROS], [xpp], [ncurses], [xterm]:
  ...
  sudo apt-get install ros-<ros-distro>-grid_map*
  ```
...
## Run
  ...
  Information about how to tune the paramters can be found [here](http://docs.ros.org/en/melodic/api/towr/html/group__Parameters.html). 
  
## Develop
#### Library overview
 * The relevant classes and parameters to build on are collected [modules](http://docs.ros.org/en/melodic/api/towr/html/modules.html).
 * A nice graphical overview as UML can be seen [here](http://docs.ros.org/en/melodic/api/towr/html/inherits.html).
 * The [doxygen documentation](http://docs.ros.org/en/melodic/api/towr/html) provides helpful information for developers.
